<div id="sidebar" class="navbar-menu relative z-50 hidden sm:block">
	<!-- <div class="navbar-backdrop fixed inset-0"></div> -->
	<nav
		class="flex flex-col w-[240px] max-w-sm px-4 pt-4 bg-primarylightmode dark:bg-primarydarkmode overflow-y-auto">
		<div class="text-black dark:text-white">
			<a class="flex items-center w-full py-2 px-3 rounded-xl hover:bg-secondarylightmode dark:hover:bg-[#272727]"
				href="index.php">
				...
				<span class="ml-6 text-sm">Videos</span>
			</a>
			<a class="flex items-center w-full py-2 px-3 rounded-xl hover:bg-secondarylightmode dark:hover:bg-[#272727]"
				href="#">
				...
				<span class="ml-6 text-sm">Users</span>
			</a>
			<a class="flex items-center w-full py-2 px-3 rounded-xl hover:bg-secondarylightmode dark:hover:bg-[#272727]"
				href="#">
				<svg class="w-6 h-6 fill-black dark:fill-white" viewBox="0 0 24 24" focusable="false">
				...
				<span class="ml-6 text-sm">Admins</span>
			</a>
			<div class="flex flex-col items-center w-full mt-3 mb-3 border-t border-gray-700"></div>
			<a class="flex items-center w-full py-2 px-3 rounded-xl hover:bg-secondarylightmode dark:hover:bg-[#272727]"
				href="#">
				<svg class="w-6 h-6 fill-black dark:fill-white" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
					<path d="m11 7 6 3.5-6 3.5V7zm7 13H4V6H3v15h15v-1zm3-2H6V3h15v15zM7 17h13V4H7v13z"></path>
				</svg>
				<span class="ml-6 text-sm">Blank</span>
			</a>
			<a class="flex items-center w-full py-2 px-3 rounded-xl hover:bg-secondarylightmode dark:hover:bg-[#272727]"
				href="#">
				<svg class="w-6 h-6 fill-black dark:fill-white" viewBox="0 0 24 24" focusable="false">
						...
						<svg viewBox="0 0 97 20" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
							<g>
								<path
									...
									fill="#FF0000"></path>
								<path class="fill-white" d="M11.4275 14.2854L18.8475 10.0004L11.4275 5.71533V14.2854Z">
								</path>
							</g>
							<g>
								<path
			...
			<div class="flex flex-col items-center w-full mt-2 border-t border-gray-700">
				<a class="flex items-center w-full py-2 px-3 mt-2 rounded-xl hover:bg-secondarylightmode dark:hover:bg-[#272727]"
					href="#">
					<svg class="w-6 h-6 fill-black dark:fill-white" enable-background="new 0 0 24 24"
						viewBox="0 0 24 24" focusable="false">
						<path
