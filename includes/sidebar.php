<nav class="flex items-center space-x-6 mr-5">
    <div class="flex flex-col hidden sm:block items-center h-full hover:overflow-y-auto text-black dark:text-white bg-primarylightmode dark:bg-primarydarkmode">
        <div class="w-full px-2" id="sidebar-collapsed">
            <div class="flex flex-col items-center w-full border-gray-700 ml-1.5">
                <a class="flex items-center w-full py-2 px-3 mt-2 bg-secondarylightmode dark:bg-secondarydarkmode rounded-xl hover:secondarylightmode dark:hover:bg-[#272727]"
                    href="#">
                    ...
                    <div class="side-text">
                        <span class="ml-6 mr-24 text-sm">Home</span>
                    </div>
                </a>
